class ClaudeUsageCli < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/gongahkia/claude-usage-tracker/releases/download/v#{version}/claude-usage-arm64"
      sha256 "PLACEHOLDER_ARM64_SHA256"
    else
      url "https://github.com/gongahkia/claude-usage-tracker/releases/download/v#{version}/claude-usage-x86_64"
